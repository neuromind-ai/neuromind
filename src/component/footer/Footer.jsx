      ...
      <div className='footer_container'>
        ...
        <div className="link">
          <ul className="hyper_link">
            ...
            <li><a href="http://" target="_blank" rel="noopener noreferrer"><MdOutlineAlternateEmail />Email</a></li>
            <li><a href="http://" target="_blank" rel="noopener noreferrer"><FaInstagram />Instagram</a></li>
            <li><a href="http://" target="_blank" rel="noopener noreferrer"><FiMessageCircle />Message</a></li>
            <li><a href="http://" target="_blank" rel="noopener noreferrer"><FaTwitter />Twitter</a></li>
