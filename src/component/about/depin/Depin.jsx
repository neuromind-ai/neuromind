...
import greenbox from './greenbox.svg'
        ...
        <>
            ...
            <div className='depin_main_container'>
                ...
                <div className="depin_container">
                    <div className="text">
                        <h3>Let Neuromind guide you in spinning up nodes for DePIN</h3>
                        <p>Effortlessly navigate risk-adjusted exposure to AI projects</p>
                    </div>
                    <div className="three_content">
                        ...
                        <div className="content_2">
                            ...
                            <div className="content_2_table">
                                <div className="black"></div>
                                {/* <img src={tablegray} alt="" /> */}
